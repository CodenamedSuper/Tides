...
public class MarinalBlock extends Block implements Waterloggable {
    public static final MapCodec<MarinalBlock> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        ...
        }), createSettingsCodec()).apply(instance, MarinalBlock::new);
    });
    ...
    public MapCodec<MarinalBlock> getCodec() {
        return CODEC;
    }

    public MarinalBlock(float height, float xzOffset, AbstractBlock.Settings settings) {
        super(settings);
